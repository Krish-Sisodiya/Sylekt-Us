...
import { Code2, Rocket, Users, Sparkles, Award, Send, type LucideProps } from "lucide-react";

// Types define kar dete hain taaki TS pareshan na kare
type FeatureItem = [React.ComponentType<LucideProps>, string];
...
const coders = [
  {
    ...
    image: "/img/pawan.png" // Public folder ke liye path sahi kar diya
  },
  {
    name: "Brajesh Kamle",
    role: "Lead Frontend Engineer",
    skills: ["TypeScript", "UI/UX", "Animation"],
    image: "/img/brajesh.jpeg"
  },
  {
            ...
            <div className='rounded-[36px] p-[1px] bg-gradient-to-br from-cyan-400/40 to-blue-500/30'>
              <div className='rounded-[36px] bg-[#08172d] p-8 border border-white/5'>
                <div className='grid gap-6'>
                  ...
                  ] as FeatureItem[]).map(([Icon, label], i) => (
            ...
            <motion.div
              ...
              <div className='rounded-[34px] overflow-hidden bg-[#08172d] border border-white/5'>
                <div className='h-[380px] overflow-hidden'>
                  <img src={coder.image} alt={coder.name} className='w-full h-full object-cover group-hover:scale-110 transition duration-1000' />
                </div>
                <div className='p-8'>
          ...
          <div className='rounded-[40px] bg-[#08172d] border border-white/5 p-8 md:p-14'>
            <div className='grid lg:grid-cols-2 gap-14 items-center'>
              ...
              <form className='grid gap-5'>
                ...
                <button type="button" className='mt-3 inline-flex items-center justify-center gap-3 rounded-full px-8 py-5 font-semibold bg-gradient-to-r from-blue-500 to-cyan-400 hover:scale-105 transition'>
